...
! function() { $.fn.stepsForm = function(t) { var e = { width: "100%", active: 0, errormsg: "Check faulty fields.", sendbtntext: "Submit", posturl: "core/demo_steps_form.php", theme: "" },
            t = $.extend(e, t); return this.each(function() {
            function e(e) { for (requredcontrol = !1, i = 0; i < e; i++) f.find(".sf-steps-form>ul").eq(i).find(":input").each(function() { "true" == $(this).attr("data-required") && "" == $(this).val() ? ($(this).addClass("sf-error"), requredcontrol = !0) : "true" != $(this).attr("data-required") || "radio" != $(this).attr("type") && "checkbox" != $(this).attr("type") ? "" != $(this).val() && ("true" == $(this).attr("data-email") && 0 == r($(this).val()) && ($(this).addClass("sf-error"), requredcontrol = !0), "true" == $(this).attr("data-number") && isNaN($(this).val()) && ($(this).addClass("sf-error"), requredcontrol = !0), "true" == $(this).attr("data-confirm") && (h.push($(this).val()), u.push($(this)), a())) : "radio" == $(this).attr("type") ? $(this).parent().parent().find("input[type='radio']:checked").length < 1 && ($(this).addClass("sf-error"), requredcontrol = !0) : $(this).parent().parent().find("input[type='checkbox']:checked").length < 1 && ($(this).addClass("sf-error"), requredcontrol = !0) });
		...
		$(document).ready(function(e) {
					...
					function delcont() {
    document.getElementById("reco").innerHTML=" The Recommendation has been Deleted!";
}
